          ...
          <div className="grid md:grid-cols-3">
            ...
            <div className="md:col-span-2 p-8 md:p-12">
              <div className="space-y-4 text-lg text-foreground/80">
                <p>
                  Hello! I&apos;m Muhammad Nashirul Haq Resa, Software Engineer with versatile technical skills covering Mobile (Flutter/Kotlin), Full stack Web,
and Game Development. I have a track record of innovation as a Top 10 Finalist in KIBB and
holder of the Copyright for an application that integrates AI with native features, proving my
ability to handle complex programming logic. These competencies are reinforced by practical
experience in database management, network configuration, and the implementation of industry
standards throughout every application development cycle.
                </p>
                <p>
